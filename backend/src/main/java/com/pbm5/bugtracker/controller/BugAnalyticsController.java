...
public class BugAnalyticsController {
        ...
        public ResponseEntity<BugAnalyticsService.ProjectBugStatistics> getProjectStatistics(
                ...
                BugAnalyticsService.ProjectBugStatistics statistics = bugAnalyticsService.getProjectStatistics(
                                projectSlug,
                                startDate, endDate);
        ...
        public ResponseEntity<BugAnalyticsService.ProjectReport> generateProjectReport(
                ...
                BugAnalyticsService.ProjectReport report = bugAnalyticsService.generateProjectReport(projectSlug,
                                startDate,
                                endDate);
